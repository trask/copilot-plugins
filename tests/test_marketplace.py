...
EXPECTED_PACKAGE_VERSIONS = {
    "agent-tasks-runtime": "1.0.41",
    "ci-fix-loop": "1.6.94",
    "copilot-review-loop": "1.1.100",
    "historical-pr-audit": "1.1.45",
    "pr-conflict-resolver": "1.1.70",
    "pr-description": "1.0.96",
    "pr-pipeline": "1.5.66",
    "pr-reviewer": "1.8.35",
    "self-review-loop": "1.3.76",
}
