...
- The helper requires the managed `cloud_task.py` from `trask/copilot-config` commit `e67d61da91c514eeea12179997aa4f35d3d737da` and policy `marketplace-agent-worker@1`.
