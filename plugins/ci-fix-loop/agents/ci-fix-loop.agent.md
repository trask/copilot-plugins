...
The command discovers `cloud_task.py` from the separately installed `agent-tasks-runtime@trask-plugins` skill, verifies its SHA-256 `4756e0564359d9198c31190794c33a8120789715628139467f7e8c2d85c1e3b5`, and invokes it with `--result-file`, `--policy marketplace-agent-worker@1`, and absolute prompt and result paths outside the repository. The policy SHA-256 is `c87e380b050a2af8c275eb2413893304ca7b7ff28bd1ae074a07ae5e66c40189`.
